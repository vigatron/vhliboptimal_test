...
# Includes 746 Related
set(APP_INCLUDE_DIRS

    ${APP_STM32_DIR}/platformstm32f746
    ${APP_STM32_DIR}/platformstm32f746/Core/Inc
    ${APP_STM32_DIR}/platformstm32f746/USB_DEVICE/App
    ${APP_STM32_DIR}/platformstm32f746/USB_DEVICE/Target

    ${CUBEMX_PATH}/Drivers/CMSIS/Device/ST/STM32F7xx/Include
...
set(USB_User_Src
    ${APP_STM32_DIR}/platformstm32f746/USB_DEVICE/Target/usbd_conf.c
    ${APP_STM32_DIR}/platformstm32f746/USB_DEVICE/App/usb_device.c
    ${APP_STM32_DIR}/platformstm32f746/USB_DEVICE/App/usbd_desc.c
...
set(HAL_DRIVERS_FILES
    ...
    ${HAL_DRIVER_DIR}/Src/stm32f7xx_hal_dma.c
    ${HAL_DRIVER_DIR}/Src/stm32f7xx_hal_dma_ex.c
...
set(STM32_CORE_FILES
    ...
    "${SYS_CORE_DIR}/stm32f7xx_it.c"

    "${SYS_CORE_DIR}/system_stm32f7xx.c"
